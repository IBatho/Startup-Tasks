...
plt.plot(x, trendline(x), color="steelblue", linewidth=4, label="Trendline")
plt.legend(
...
plt.xlabel("Timesteps", fontsize=30, fontweight="bold")
plt.ylabel("Mean Episode Reward", fontsize=30, fontweight="bold")
plt.xticks(fontsize=20)
plt.yticks(fontsize=20)
plt.title("PPO: Graph of Mean Episode Reward vs Timesteps", fontsize=30, fontweight="bold")
